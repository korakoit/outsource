$(function(){
  $('#show').on('click', function(){
    $('#gallary').modal({backdrop: 'static', keyboard: false});
  })

  //标签页
  $('#gallaryTab li:eq(1)').click(function (e) {
    e.preventDefault();
    $('[role=tabpanel]').removeClass('active');
    $('#upload').removeClass('hidden');
  });
  $('#gallaryTab li:eq(0)').click(function (e) {
    e.preventDefault();
  ...
  var uploader = Qiniu.uploader({
        ...
        filters : [ {title : "图片文件", extensions : "jpg,jpeg,gif,bmp,png"} ],
        ...
        init: {
            ...
            'BeforeUpload': function(up, file) {
                var folder = $('#exampleInputEmail1').val()||'';
            ...
            'UploadComplete': function() {
                // $('#success').show();
                $('table td').child('div.info').child('div').html('上传成功');
                $('.infoWrapper .fopLink').hide();  //查看
                $('.infoWrapper a:eq(1)').hide(); //查看
                return false;
            },
            ...
            'Error': function(up, err, errTip) {
                ...
                $('table td').child('div.info').child('div').find(a).text('上传失败');
            }
                // ,
  ...
  function selectable(){
    ...
    $( "#selectable" ).selectable({
       ...
       var result = $( "#select-result" ).empty();
        $( ".ui-selected", this ).each(function() {
         var index = $( "#selectable .thumbnail" ).find('img');
        });
    ...
    // $('#selectedTip').selectable();
    //$("ol#selectable").child('div').on('click',function(){
        //alert('sbs');
  ...
  function selectable2(){
    ...
    //   }
    // });
     $( "#fsUploadProgress" ).on('click','tr',function(){
        $(this).toggleClass('ui-selected');
     });
  }
selectable2();
