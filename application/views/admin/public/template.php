            	...
            	<div class="tabbable tabbable-custom">
                     <ul class="nav nav-tabs" id="list">
                        ...
                        <form class="form-horizontal" id="template_content_form" method="post" action="<?=base_url('public_template/save')?>" novalidate="novalidate" > 
                       	...
                       	<h3>下单信息</h3>
                       	<div class="controls">
                        <ul class="unstyled inline sidebar-tags" id="sort6">
                       	<li style="margin-top:5px">
                       	</li>
                       	<li style="margin-top:5px" onclick="$('#template_dialog').modal('show');" class='order_info'>
                        <a href="javascript:void(0)">
                        <i class="icon-add">+</i>
                       	...
                       	<h3>酒店信息</h3>
                       	<div class="controls">
                        <ul class="unstyled inline sidebar-tags" id="sort7">
                       	<li style="margin-top:5px">
                       	</li>
                       	<li style="margin-top:5px" onclick="$('#template_dialog').modal('show');" class='hotel_info'>
                        <a href="javascript:void(0)">
                        <i class="icon-add">+</i>
                       	...
                       	<h3>联系人信息</h3>
                       	<div class="controls">
                        <ul class="unstyled inline sidebar-tags" id="sort8">
                       	<li style="margin-top:5px">
                       	</li>
                       	<li style="margin-top:5px" onclick="$('#template_dialog').modal('show');" class='contact_info'>
                        <a href="javascript:void(0)">
                        <i class="icon-add">+</i>
                       	...
                       	<h3>出行人信息</h3>
                       	<div class="controls">
                        <ul class="unstyled inline sidebar-tags" id="sort9">
                       	<li style="margin-top:5px">
                       	</li>
                       	<li style="margin-top:5px" onclick="$('#template_dialog').modal('show');" class='travel_info'>
                        <a href="javascript:void(0)">
                        <i class="icon-add">+</i>
                       	...
                       	<h3>司机信息</h3>
                       	<div class="controls">
                        <ul class="unstyled inline sidebar-tags" id="sort10">
                       	<li style="margin-top:5px">
                       	</li>
                       	<li style="margin-top:5px" onclick="$('#template_dialog').modal('show');" class='driver_info'>
                        <a href="javascript:void(0)">
                        <i class="icon-add">+</i>
                       	...
                       	<h3>乘客信息</h3>
                       	<div class="controls">
                        <ul class="unstyled inline sidebar-tags" id="sort11">
                       	<li style="margin-top:5px">
                       	</li>
                       	<li style="margin-top:5px" onclick="$('#template_dialog').modal('show');" class='passenger_info'>
                        <a href="javascript:void(0)">
              ...
              <form class="form-horizontal" id="form_sample_2" action="#" novalidate="novalidate">
                        ...
                        <div class="control-group">
                           <label class="control-label">酒店信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php foreach ($list as $k=>$v):?>
                                 <?php if($v['f_class']=='hotel_info'&&$v['s_right']!=="不可见/不可编辑"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px" >
                        ...
                        <div class="control-group">
                           <label class="control-label">联系人信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php foreach ($list as $k=>$v):?>
                                 <?php if($v['f_class']=='contact_info'&&$v['s_right']!=="不可见/不可编辑"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                        ...
                        <div class="control-group">
                           <label class="control-label">出行人信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php foreach ($list as $k=>$v):?>
                                 <?php if($v['f_class']=='travel_info'&&$v['s_right']!=="不可见/不可编辑"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                        ...
                        <div class="control-group">
                           <label class="control-label">司机信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php foreach ($list as $k=>$v):?>
                                 <?php if($v['f_class']=='driver_info'&&$v['s_right']!=="不可见/不可编辑"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                        ...
                        <div class="control-group">
                           <label class="control-label">乘客信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 <ul class="unstyled inline sidebar-tags selectpassenger_info" id="ticket">
                                 <?php foreach ($list as $k=>$v):?>
                                 <?php if($v['f_class']=='passenger_info'&&$v['s_right']!=="不可见/不可编辑"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
...
<script type="text/javascript">
      ...
      var list6  =  document.getElementById("sort6");
      var list7 =  document.getElementById("sort7");
      var list8 =  document.getElementById("sort8");
      var list9 =  document.getElementById("sort9");
      var list10 =  document.getElementById("sort10");
      var list11 =  document.getElementById("sort11");
