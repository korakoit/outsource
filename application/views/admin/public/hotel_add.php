         	...
         	<div class="span12">
                    	<form  class="form-horizontal" method="post"  id="add-form">
                           <div class="control-group">
                            	...
                            	<div class="controls">
                            	<select class="span2" name="country" id="country" class="form-control span2">
                            			<option><<---请选择国家--->></option>
                        	...
                        	<label  class="control-label">城市名称<span class="required" style="color:red;">*</span></label>
                            	<div class="controls">
                            	   ...
                            	   <option><<---请选择城市--->></option>
	                            		...
	                            		<option  value="<?=$cityRow['id']?>"><?=$cityRow['city_name']?></option>
	                            		<?php endif;?>
	                            		<?php endforeach;?>
	                            		<?php endif;?>
                            	   </select>
                        	...
                        	<div class="control-group">
                            	...
                            	<div class="controls">
                            	   ...
                            	   <option   value="<?=$areaRow['id']?>"><?=$areaRow['area_name']?></option>
                            	   <?php endif;?>
                            	   <?php endforeach;?>
                            	   <?php endif;?>
                            	   </select>
                           ...
                           <div class="control-group">
                            	...
                            	<div class="controls">
                            	<input type="text" class="form-control" name="hotel_engname"  id="hotel_engname">
                        ...
                        <div class="control-group">
                            	...
                            	<div class="controls">
                            	<input type="text"   class="form-control" name="hotel_chname"  id="hotel_chname">
                        ...
                        <div class="control-group">
                         ...
                         <div class="control-group">
                            	...
                            	<div class="controls">
                            	<input type="text" class="form-control" name="backup_phone"  id="backup_phone">
                         ...
                         <div class="control-group">
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                            	...
                            	<div class="controls">
                            	<textarea name="backup" cols="100" rows="3"></textarea>
                            	</div>
                            </div>
