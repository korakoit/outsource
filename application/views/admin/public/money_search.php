	...
	<div class="row">
		<div class="col-sm-12">
        	<div class="nest" id="tagInputClose">
				...
				<div class="title-alt">
				<form  class="form-horizontal" method="get" action="<?=site_url('public_country/search')?>">
                	...
                	<table class="table-striped footable-res footable metro-blue">
                    	<thead>
                       	...
                       	<?php foreach($info->result() as $v){
                       	    $edit = site_url('public_money/edit/'.$v->id);
                       	    $delete = site_url('public_money/delete/'.$v->id); 
                       	?>
                       	<tbody>
                       		<tr>
                       		       <td><?= $v->id?></td>
