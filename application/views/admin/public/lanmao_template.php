                           ...
                           <label class="control-label">联系人信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php if($v['f_class']=='contact_info'&&$v['status']==1):?>
                                  ...
                                  <?php elseif($v['f_class']=="contact_info"&&$v['status']==1&&$v['lm_right']=="不可编辑"):?>
                                   	   <li style="margin-top:5px"><a><?=$v['ch_name']?><i class="icon-remove"></i></a></li>
                                  <?php endif;?>
                                  <?php endforeach;?>
                                </ul>
                            </div>
                           ...
                           <label class="control-label">出行人信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php if($v['f_class']=='travel_info'&&$v['status']==1):?>
                                  ...
                                  <?php elseif($v['f_class']=="travel_info"&&$v['status']==1&&$v['lm_right']=="不可编辑"):?>
                                   	   <li style="margin-top:5px"><a><?=$v['ch_name']?><i class="icon-remove"></i></a></li>
                                  <?php endif;?>
                                  <?php endforeach;?>
                                </ul>
                           ...
                           <label class="control-label">司机信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php if($v['f_class']=='driver_info'&&$v['status']==1):?>
                                   ...
                                   <?php elseif($v['f_class']=="driver_info"&&$v['status']==1&&$v['lm_right']=="不可编辑"):?>
                                   	   <li style="margin-top:5px"><a><?=$v['ch_name']?><i class="icon-remove"></i></a></li>
                                  <?php endif;?>
                                  <?php endforeach;?>
                                </ul>
                        ...
                        <div class="control-group">
                           <label class="control-label">乘客信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php elseif($v['f_class']=="passenger_info"&&$v['status']==1&&$v['lm_right']=="不可编辑"):?>
                                 <li style="margin-top:5px"><a><?=$v['ch_name']?><i class="icon-remove"></i></a></li>
                                  <?php endif;?>
                                  <?php endforeach;?>
                                </ul>
