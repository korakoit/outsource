            ...
            <div class="span12">
            	<div class="tabbable tabbable-custom">
                     <ul class="nav nav-tabs" id="list">
                        ...
                        <a id="travel"  href="<?=base_url('public_template/show/'.$cateRow['id']).'/'.'confirm'.'/'.'#a'?>"><?=$cateRow['name']?></a>
                        </li>
                        <?php endif;?>
                        <?php endforeach;?> 
                      </ul>
                        ...
                        <?php if($status == 1):?>
                       	<label class="help-inline">懒猫订单详情模板信息尚未填写</label>
                       	<?php elseif($status == 2):?>
                       <div class="portlet-body form">
                        ...
                        <i class="icon-add">+</i>
                       	 ...
                       	 <div class="control-group">
                           <h3>注意事项</h3><span class="required" style="color:white;">*</span>
                              <div class="controls">
                              <textarea rows="6" cols="40" class="span8" name="attention"></textarea>
                              </div>
                       	</div>
                        ...
                        <i class="icon-add">+</i>
                           ...
                           <h3>注意事项</h3><span class="required" style="color:white;">*</span>
                              <div class="controls">
                              <textarea rows="6" cols="40" class="span8" name="attention"><?php if(!empty($attention)){echo $attention;}?></textarea>
                              </div>
                       </div>
                       	</div>
                       	<div class="form-actions">
              ...
              <form class="form-horizontal" id="form_sample_2" action="#" novalidate="novalidate">
                        <div class="control-group">
                           <label class="control-label">下单信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php if($v['f_class']=="order_info"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                                            <input type="hidden"  name="order_id[]" class="id" value="<?=$v['id']?>"/>
                        ...
                        <div class="control-group">
                           <label class="control-label">酒店信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php if(!empty($order_list)):?>
                                 <?php foreach ($order_list as $v):?>
                                 <?php if($v['f_class']=="hotel_info"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px" >
                        ...
                        <div class="control-group">
                           <label class="control-label">联系人信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php if(!empty($order_list)):?>
                                 <?php foreach ($order_list as $v):?>
                                 <?php if($v['f_class']=="contact_info"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                                            <input type="hidden" name="contact_id[]" class="id" value="<?=$v['id']?>"/>
                                            <input type="hidden"  class="f_class" value="<?=$v['f_class']?>"/>
                        ...
                        <div class="control-group">
                           <label class="control-label">出行人信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 ...
                                 <?php if(!empty($order_list)):?>
                                 <?php foreach ($order_list as $v):?>
                                 <?php if($v['f_class']=="travel_info"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                                            <input type="hidden" name="travel_id[]" class="id" value="<?=$v['id']?>"/>
                                            <input type="hidden"  class="f_class" value="<?=$v['f_class']?>"/>
                        ...
                        <div class="control-group">
                           <label class="control-label">司机信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                ...
                                <?php if(!empty($order_list)):?>
                                <?php foreach ($order_list as $v):?>
                                <?php if($v['f_class']=="driver_info"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                                            <input type="hidden" name="driver_id[]" class="id" value="<?=$v['id']?>"/>
                                            <input type="hidden"  class="f_class" value="<?=$v['f_class']?>"/>
                        ...
                        <div class="control-group">
                           <label class="control-label">乘客信息<span class="required" style="color:red;">*</span></label>
                              <div class="controls">
                                 <ul class="unstyled inline sidebar-tags selectticket_info" id="ticket">
                                <?php if(!empty($order_list)):?>
                                <?php foreach ($order_list as $v):?>
                                <?php if($v['f_class']=="passenger_info"&&$v['status']==1):?>
                                        <li onclick="selecte_field(this)" style="margin-top:5px">
                                            <input type="hidden" name="passenger_id[]" class="id" value="<?=$v['id']?>"/>
                                            <input type="hidden"  class="f_class" value="<?=$v['f_class']?>"/>
