...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <form class="form-horizontal" action="/product/saveCounDesc/" method="post" >
                    <div class="control-group">
                        <label class="control-label">国家名：</label>
                        <div class="controls">
                            <input type="text" disabled="" class="m-wrap medium" value="<?=$desc['country_name']?>" name="counname">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">排序：</label>
                        <div class="controls">
                            <input type="text" class="m-wrap medium" name="counord" value="<?=$desc['ord']?>">
                        </div>
                    </div>
                    <div class="control-group">
            ...
            <div class="row-fluid">
                <table class="table table-border table-bordered table-hover table-bg">
                    ...
                    <tbody>
                        <?php if(!empty($list)):?>
                            <?php foreach($list as $counKey => $counRow):?>
                                <tr class="text-c">
                                    <td><?=$counRow['city_name']?></td>
                                    <td>
                                        <input type="hidden" name="id[]" value="<?=$counRow['id']?>">
                                        <div class="coefficient">
                                            <div style="display:none" class="rank"><?=$counRow['ord']?></div>
                                            <span class="fontgeo f14 red"><?=$counRow['ord']?></span>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#updateCoefficient").live('click',function(){
            ...
            $.ajax({
                url:'/product/editcountryrank',              //后台处理程序路径
                type:'post',        							//数据发送方式
