                    ...
                    <div class="clearfix margin_left_90">
                        ...
                        <div class="control-group pull-left margin-right-20"  style="margin-left:-20px;">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" name="title" class="medium m-wrap" placeholder="Input Name"value="<?=isset($search['title'])?$search['title']:''?>">
                    ...
                    <?php if (isset($result)):?>
                        <?php foreach ($result as $key=>$value):?>
                            <tr>
                                ...
                                <td class="hidden-480"><input onclick="sort('<?=$value['id']?>')" value="<?=$value['sort']?>"/></td>
                                <td class="hidden-480">
                                    <button class="btn blue" onclick="edit('<?=$value['id']?>','<?=$value['title']?>')">Edit</button>
                                    <a class="btn blue" href="<?=base_url('admin/product/list?category_id='.$value['id'])?>">Product Edit</a>
                                </td>
                            </tr>
                        <?php endforeach;?>
                    <?php else:?>
